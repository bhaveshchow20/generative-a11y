...
// Call when the chat is removed, not after each response.
  ...
  return (
    <section className="home-quick-start" aria-labelledby="quick-start-title">
      <div className="home-section-heading">
        ...
        <p>Install core and DOM, then report events from your existing chat.</p>
        <pre
          className="home-static-install"
          role="region"
          tabIndex={0}
          aria-label="Core and DOM install command"
        >
          <code>npm install @generative-a11y/core @generative-a11y/dom</code>
        </pre>
      ...
      <div className="home-code-frame">
        <div>
          <span>core + dom</span>
          <span>chat-accessibility.ts</span>
        </div>
        <pre
          role="region"
          tabIndex={0}
          aria-label="Core and DOM quick start code"
        >
          <code>{example}</code>
        </pre>
      </div>
