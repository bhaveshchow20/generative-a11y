...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <CheckIcon className="ga-:ml-auto ga-:opacity-0 ga-:group-has-data-[slot=command-shortcut]/command-item:hidden ga-:group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  );
}
